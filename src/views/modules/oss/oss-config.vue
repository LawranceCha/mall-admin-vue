  ...
  <el-dialog title="云存储配置"
    ...
    <el-form :model="dataForm"
      ...
      <template v-if="dataForm.type === 1">
        <el-form-item size="mini">
          <a href="http://www.renren.io/open/qiniu.html"
             target="_blank">免费申请(七牛)10GB储存空间</a>
        </el-form-item>
      ...
      <template v-else-if="dataForm.type === 4">
        <el-form-item label="域名">
          <el-input v-model="dataForm.qcloudDomain"
                    placeholder="Minio's address"></el-input>
        </el-form-item>
        <el-form-item label="路径前缀">
          <el-input v-model="dataForm.qcloudPrefix"
                    placeholder="prifix,不设置默认为空"></el-input>
        </el-form-item>
        <el-form-item label="accessid">
          <el-input v-model="dataForm.qcloudSecretId"
                    placeholder="Minio's accessid"></el-input>
        </el-form-item>
        <el-form-item label="SecretKey">
          <el-input v-model="dataForm.qcloudSecretKey"
                    placeholder="Minio's SecretKey"></el-input>
        </el-form-item>
        <el-form-item label="BucketName">
          <el-input v-model="dataForm.qcloudBucketName"
                    placeholder="Minio's BucketName"></el-input>
        </el-form-item>
      </template>
    </el-form>
    <span slot="footer"
